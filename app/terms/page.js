...
export const metadata = {
  title: "Terms & Conditions — Ennis Global",
  description:
    "Terms governing use of the Ennis Global website and engagement with our advisory services.",
};
        ...
        items: [
          {
            ...
            text:
              "These Terms, together with any engagement letter, constitute the entire agreement between you and Ennis Global regarding the subject matter and supersede prior agreements on the same subject.",
          },
          {
          ...
          },
          {
            ...
            text:
              "Neither party is liable for delays or failures caused by events beyond reasonable control, including natural disasters, labor disputes, government action, or communications failures.",
          },
        ],
      },
    ],
...
export default function TermsPage() {
  return (
    <LegalLayout
      ...
      intro="These Terms set the rules of engagement for using this site and working with our team. Specific advisory engagements are governed by a signed engagement letter; until that letter exists, nothing here is a promise of services. Read carefully — and if anything is unclear, we would rather explain it than leave it ambiguous."
      sections={sections}
      sidebarNote="Reviewing for procurement or legal?"
    />
  );
}
